...
/**
 * Class Async2ActionMessageHandler
 * @package App\MessageHandler
 */
class Async2ActionMessageHandler implements MessageSubscriberInterface
{
    /**
    ...
    {
        echo "start of the message handler action for async2" . PHP_EOL;
        echo "---------------------" . PHP_EOL;
        ...
        echo "---------------------" . PHP_EOL;
        echo "end of the message handler action for async2" . PHP_EOL;
        echo "---------------------" . PHP_EOL;
