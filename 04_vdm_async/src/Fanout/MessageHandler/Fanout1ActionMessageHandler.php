...
/**
 * Class Fanout1ActionMessageHandler
 * @package App\Fanout\MessageHandler
 */
class Fanout1ActionMessageHandler implements MessageSubscriberInterface
{
    /**
    ...
    {
        echo "start of the message handler action for fanout1" . PHP_EOL;
        echo "---------------------" . PHP_EOL;
        ...
        echo "---------------------" . PHP_EOL;
        echo "end of the message handler action for fanout1" . PHP_EOL;
        echo "---------------------" . PHP_EOL;
